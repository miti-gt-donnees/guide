...
- les 2 premieres phases "Imaginer et Concevoir Planifier", les étapes préparatoire d'un projet, où l'on se préoccupera d'avoir toutes les informations nécessaires (formations, infrastructures), des plans de gestion de données, mettre en place une politique FAIR
