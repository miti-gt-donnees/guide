...
Dans ce document, nous avons donc voulu témoigner des travaux réalisés au sein de nos réseaux métiers qui rendent compte d’une gestion optimisée des données de la recherche tout en guidant le lecteur vers de bonnes pratiques à travers des liens vers d'autres ressources pédagogiques lui permettant d’approfondir le sujet. 
