...
<img src="https://www.cnrs.fr/mi/IMG/png/donnees.png" width=50% height=50% alt="cycle de vie des données">
...
Ce guide est donc un document un peu hybride et atypique proche du vademecum, composé d’un inventaire d’actions de formations (conférences, séminaires, présentations), d’un répertoire de liens pour approfondir le sujet, de recommandations professionnelles, complétées de définitions utiles.
...
Ce guide est destiné à être évolutif et s'enrichira au fil du temps par les pratiques des autres réseaux métiers de la MITI et des Instituts du CNRS
