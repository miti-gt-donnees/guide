...
L'objectif a donc été de rendre compte de ces pratiques et d'élaborer un "guide de bonnes pratiques" dans la gestion des données scientifiques qui peut aider le lecteur neophyte ou d'autres réseaux
à analyse rleur besoin et trouver des réponses dans les problématiques de gestion.
