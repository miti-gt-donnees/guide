...
- la phase 7 enfin permettra de diffuser les données correctemen à travers des catalogues de données, des identifiants pérennes et des entrepots de données.
