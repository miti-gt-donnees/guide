...
- la phase 7 enfin permettra de diffuser les données correctement à travers des catalogues de données, des thesaurus fournissant une interopérabilité sémantique, des identifiants pérennes et des entrepots de données, des datapaper .
