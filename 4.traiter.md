...
Après la phase de collecte de données que nous avons vue dans l'étape précédente du cycle de vie des données, il est nécessaire de se préoccuper du dépôt et de la facilité d'accès et de la réutilisation des données localement dans une unité de recherche.
