...
Toutefois là encore si les métadonnées sont bien utiles dans la description d'un dichier NetCDF, on peut y mettre ce qu'on veut, et donc une standardisation des métadonnées NetCDF est
utile et nécessaire. Il est utile d'utiliser la [convention CF (climate forecast)](https://cfconventions.org/) qui permet de standardiser autant que faire se peut les métadonnées
...
et par le projet Européen Seadatanet.
