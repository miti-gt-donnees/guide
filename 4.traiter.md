...
Des logiciels sont particulièrement adaptés dans la diffusion et l'affichage des données scientifiques d'observation, de plus en utilisant les standards interopérables de l'Open Geospatial Consortium (OGC), ISO19139, Inspire, etc)
...
précédentes étapes du cycee de vie des données, il est nécessaire "in fine" de se préoccuper de la valorisation des données en
