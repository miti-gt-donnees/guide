...
Parmi les formats recommandés, le format NetCDF est particulièrement adapté et permet d'insérer les métadonnées qui sont véhiculées dans le fichier avec les données elles mêmes.
...
Dans le domaine du climat par exemple, il est recommandé d'utiliser la [convention CF (climate forecast)](https://cfconventions.org/) qui permet de standardiser autant que faire se peut les métDévelopper les procédures d'intégration des données dans les bases de donnéesadonnées inscrites dans une entête NetCDF.
...
*  Les logiciels comme [Thredds](https://www.unidata.ucar.edu/software/tds/) et [Erddap](https://coastwatch.pfeg.noaa.gov/erddap/index.html) sont des plateformes web de gestion de données particulièrement adaptées pour rendre les données FAIR et en faciliter la diffusion des données.
...
* Sabine Darras, Observatoire Midi-Pyrénées
  * [SIST 2019](https://sist19.sciencesconf.org/)                                                                          
...
* [Visualisation et analyse des données marines et littorales avec Sextant](https://sist16.sciencesconf.org/data/pages/03_M_Treguer.pdf) 

  *  M. Treguer , C. Satra-Le Bris, J.Meillon, E. Quimbert,  Ifremer
  *  [SIST 2016](https://sist16.sciencesconf.org) 
...
- Une [présentation](http://rbdd.cnrs.fr/IMG/pdf/openrefinecours.pdf?518/a69ce451abd02003a0e96957e39828e0f2e9f2ee) autour de l'outil OpenRefine de nettoyage et mise en forme des données. Cette présentation s'est accompagnée d'un TP disponible sur la page de l'ANF.
  - Mathieu SABY, BU Université de Nice Sophia-Antipolis

D'autres interventions concernant la validation des données de terrain, et leur intégration apporte un point de vue différent :
