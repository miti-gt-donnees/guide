...
Il s'agit souvent de regrouper, choisir, qualifier les données pertinentes, de les reformater dans des formats standards interopérables, et au final de gérer les métadonnées :
...
- l'aide aux choix de la solution la plus adaptée, 
