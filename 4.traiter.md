...
Toutefois dans son format originel NetCDF n'impose rien comme metadonnées, et on peut y mettre ce qu'on veut comme libellé de variables, unités, etc., ce qui nécessite donc une standardisation des métadonnées NetCDF. 
