...
## Contexte 
Cette étape du cycle de vie des données est destinée à fltrer, regrouper, choisir les données pertinentes, reformater, gérer les métadonnées :
...
Mes équipes ont besoin de travailler en salles propres : comment préparer l'installation dans nos locaux ?
...
Comment doit-on travailler en salles propres ? 
Quelles sont les bonnes pratiques de gestion d'une salle propre ?
