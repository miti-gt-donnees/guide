...
Toutefois le format n'impose rien comme libellé de variables, unités, et on peut y mettre ce qu'on veut, ce qui nécessite donc une standardisation des métadonnées NetCDF. 
