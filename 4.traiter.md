...
est particulièrement interessant pour représenter des données qui sont des séries temporelles, des profils verticaux ou des trajectoires.
...
Ainsi les métadonnées sont embarquées et véhiculées dans le fichier avec les données elles memes.
