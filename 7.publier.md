...
Par ailleurs certaines infrastructures proposent un service de fourniture de DOI comme le [pôle de données Odatis](https://www.odatis-ocean.fr/) fournit des D.O.I pour les données _marines_ <https://www.seanoe.org/>
...
) : gestion de contenu et documentation des données -  2016 Paris 
:::
...
On trouvera dans Doranum les présentations inéressantes pour utiliser l'entrepôt nakala
* https://doranum.fr/2017/06/22/tutoriel-deposer-et-documenter-ses-donnees-dans-nakala/

* https://doranum.fr/2016/10/12/nakala-plate-forme-pour-deposer-documenter-et-diffuser-les-donnees-de-la-recherche/
...
[cette référence est a déplacer elle ne parle pas de datapaper mais du cycle de vie complet]
:::{admonition}Réference
...
On trouvera de nombreuses informations sur la création et l'évaluation de Data paper dans le Webinaire intitulé "DataPaper: une incitation à la qualification et à la réutilisation des jeux de données" organisé par  l”[ »Atelier Données » du groupe de travail Données inter-réseaux de la MITI](https://mi-gt-donnees.pages.math.unistra.fr/site/index.html) 
