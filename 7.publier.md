...
Un Institut a également la possiblité de souscrire un contrat avec l'INIST du CNRS pour etre détenteur d'un préfixe de DOI qui servira
...
Dans cette présentation complète JC Desconnets passe en revue les rôles, fonctionnalités et les domaines d'utilisation des entrepôts de données

* _Ou comment rendre les données trouvables, accessibles et réutilisables ?_
  https://sist20.sciencesconf.org/data/pages/SIST20_entrepot_de_donnees_Desconnets.pdf
  JC Desconnets [Séminaire SIST2020](https://sist20.sciencesconf.org/)
