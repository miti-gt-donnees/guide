...
En ce sens ans le domaine environnemental où les données proviennent de mesures géolocalisées sur le terrain, le logiciel GeoNetwork [https://geonetwork-opensource.org/](https://geonetwork-opensource.org/ )est le logiciel de référence pour 
décrire et représenter les jeux de données.

Ce logiciel a plusieurs atouts. il permet de :
- décrire les jeux de données avec des modèles (template) ISO 19139
