...
Cette étape de publication et de diffusion s'accompagne également d'une action d'identification des données via des identifiants pérennes, et de dépots dans des entrepots de données.
