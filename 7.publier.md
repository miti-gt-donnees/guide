...
L'ISO 19139 définit le schéma d'inmplémentation XML pour représenter les métadonnées iso 19115
...
Le logiciel GeoNetwork par le biais du protocole WMS (Web Map Service) de l'OGC interagit avec le logiciel [GeoServer](http://geoserver.org/) pour représenter les points de mesures sur une carte et pour accéder aux données brutes
