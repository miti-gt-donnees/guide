...
Une présentation du projet Seadatanet a été faite par Michele Fichaut et Florence Conquet au [Séminaire SIST15 à l'OSU Pytheas de Marseille](https://sist15.sciencesconf.org/)
* SeaDataNet, interopérabilité à l’échelle pan-européenne
https://nuage.osupytheas.fr/index.php/s/ROh4LCpHZCWdlHz#pdfviewer


Soumaya Lahbib au séminaire SIST 16 à L'observatoire OVSQ présente comment des données de cytométrie ont été traitées et intégrées dans le portail de données Seadatanet
* Interopérabilité des données issues d’analyses par Cytométrie en Flux dans l’infrastructure Européenne SeaDataNet
https://sist18.sciencesconf.org/data/pages/26_S_Lahbib_Interoperabilite_de_donnees_pour_SeaDataNet.pdf
Soumaya Lahbib
