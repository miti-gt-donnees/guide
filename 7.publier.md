...
Soumaya Lahbib au séminaire SIST18 à L'observatoire OVSQ présente comment des données de cytométrie en flux ont été traitées et intégrées dans le portail de données Seadatanet
...
* [Mise en place d'un DOI sur les données d'un réseau d'observations océanographiques ](<https://sist16.sciencesconf.org/data/pages/16\_P\_Techine.pdf>)    
...
Marion MASSOL, CINES  
[Séminaire SIST2016 Montpellier Toulouse](http://sist16.sciencesconf.org)   
