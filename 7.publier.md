...
L'utilisation du logiciel GeoNetwork a été traitée précisément par un action de formation du [réseau SIST](https://sist.cnrs.fr/). Pour lequel on trouvera les informations
...
soient référencées de manière univoque, visibles et accessibles au même titre que les
publications.  
...
recherche. Ils concourent donc à l'interopérabilité des données.  

L'obtention de D.O.I implique des devoirs de la part du déposant, qui est de maintenir un lien permanent vers les données identifiiées.
