...
* [un outil collaboratif pour faciliter la création de vocabulaire contrôlé par des experts de domaine](https://sist18.sciencesconf.org/data/pages/12_MC_Quidoz_Thesauform.pdf)  
MC Quidoz  
[Séminaire SIST18 à l'OVSQ de Versaille](https://sist18.sciencesconf.org/)  

Lors de sist2018, Dominique Vachez a présenté les conditions requises pour une interopérabilité sémantique avec le thesaurus T_Semandiv pour la biodiversité : Choix de vocabulaires contrôlés et structurés en relations sémantiques utilisés comme référentiels permettant le partage et le croisement des données/métadonnées
...
* Evolution et nouvelles pratiques autour du thésaurus PACTOLS de Frantiq pour l’édition numérique en archéologie
https://fredoc2018.sciencesconf.org/data/pages/PACTOLS_B_Nouvel.pdf
Blandine Nouvel  (Centre Camille Jullian / Frantiq)

* La révision des PACTOLS au regard du BackBone Thesaurus
https://f.hypotheses.org/wp-content/blogs.dir/1718/files/2018/12/JourneesMASA_Pactols.pdf
Blandine Nouvel  (Centre Camille Jullian / Frantiq)
...
Maintenant au CEFE on va utiliser opentheso https://www.mom.fr/ressources-numeriques/opentheso qui est un produit open source
