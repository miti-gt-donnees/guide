...
[texte rajouté par ML pour cette pressentation]
...
Pour créer une "landing page", page d'accueil pour décrire un jeu de données, il faut s'assurer que certaines métadonnées obligatoires sont bien mentionnées et renseignées.

[ca serait bien de mettre les metadonnées obligatoire pour un DOI? ML]

Les fiches de métadonnées d'un catalogue GeoNetwork peuvent par exemple servir de "landing page" pour des données identifiées par un D.O.I. Par Exemple: le DOI de ce jeu de données, 
- https://doi.org/10.34930/5c9f6377-726b-436b-aa0f-ecc32803ef88 renvoie sur la landing page sur https://dataset.osupytheas.fr/geonetwork/srv/fre/catalog.search#/metadata/5c9f6377-726b-436b-aa0f-ecc32803ef88 d'un catalogue Geonetwork
...
A noter que dans l'Infrastructure de Recherche "Data Terra" , le pôle de données Odatis fournit un service de D.O.I pour les données
...
- avoir des métadonnées descriptives bien renseignées et faisant partie d'un thesaurus identifiées
- être un centre de dépôt certifié 
