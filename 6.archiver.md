...
Préserver, sécuriser l'information et sauevgarder voire archiver les données font partie d'une phase essentielle de la gestion des données.
Il est bon dans cette pahse de faire la différence dans cette pĥase entre les notions, parfois mal maitrisées, de *stockage, sauvegarde, archivage*.
...
GR : partie qui me semble un peu hors sujet dans ce chapitre, en tout cas ici. Peut-^tre en faire un chapitre à part ?
...
GR : Ne faut-il pas le mettre dans la liste des plateformes ?
