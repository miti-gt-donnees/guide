...
-	le coût de ces supports ou encore des modifications de format de fichiers, ou bien de l’espace de stockage nécessaires à la conservation des données.
       ...
       * enregistrement de la présentation orale : http://webcast.in2p3.fr/videos-quels_sont_les_criteres_a_prendre_en_compte_pour_la_conservation_des_donnees_cines
       Lorène Béchard et Marion Massol présentent le CINES, ses missions et l'infrastructure d'archivage au CINES. Elle abordent les différents formats, l'archivage des bases de données et les question à se poser avat d'archiver.
