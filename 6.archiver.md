...
Archiver pour un usage futur dont on peut ignorer les caractéristiques est compliqué. C'est pourquoi des retours d'expériences malheureux sont intéressants.

## Un retour d'expérience riche d'enseignement

Marie-Claude Quidoz explique pourquoi, des données portant préservées avec attention au CEFE en 1984, ont été impossibles à réutiliser vingt cinq ans plus tard. Cette expérience malheureuse est riche d'enseignements et permet très rapidement de comprendre sur un exemple concret les difficultés rencontrées qui sont de quatre ordres :
