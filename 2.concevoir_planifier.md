...
A noter qu'il existe des modèles de plans de gestion de données dits "de structure" dont la période considérée s'étend au-delà de la durée d'un seul projet. (voir si on a des références à indiquer)
...
Des discussions autour d'une Table ronde " Les Plans de Gestion des Données des projets Scientifiques, quels impacts pour les centres de Calcul et de Données ?" vous permettraont aussi d'en voir les implications pour les centres de  calcul et de données.
...
Des présentations détaillées de différentes infrastructures et de leurs services peuvent vous permettre à la fois de découvrir le large paysage de l'offre en Europe et en France mais aussi de vérifier rapidement si les critères de votre projet peuvent être remplis par les différentes infrastructures et leurs offres de services.
...
Le projet Phénome, Infrastructure nationale de phénomique végétale
,regroupe sur 9 sites des plateformes expérimentales de phénotypage haut-débit(champ, serre, omique). Un système complet a été mis en place pour ce projet, système qui s'appuie sur les services FG-iRODS et FG-Cloud.
...
De nouvelles infrastructures apparaissent dans le paysage. Le concept de Data Lake n'est pas encore complétement défini et plusieurs initiatives travaillent sur ce sujet.

présenté dans [CEBA, un data lake dédié à l'observation des écosystèmes environnementaux](https://jcad2019.sciencesconf.org/data/20191002_JCAD_CEBA.pdf) inclut :
• Site Web
• Outils d’ingestion
• Moteur d’indexation
...
Postgresql est le Système de Gestion de Bases de Données conseillé par la [circulaire Ayrault](http://rbdd.cnrs.fr/IMG/pdf/mcq_jrbdd2017.pdf?381/0207fc9b42426c781066e710f0702bdbe8c90096) que Marie-Claude Quidoz a présentée en 2017.  
