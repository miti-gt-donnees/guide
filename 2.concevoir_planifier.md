...
## Vérifier les disponibilités des infrastructures (lieu, fonctionnalités, capacités et services)
GR : différencier pres générique (ici)
GR : fournisseur plutôt que lieu ?
...
### Infrastructures pour l'information sceintifique et technique
...
REM GR je mettrais les 2 présentations suivantes (ou le plus complète) au châpitre 7 (il y en a déjà une sur le me^me sujet)
