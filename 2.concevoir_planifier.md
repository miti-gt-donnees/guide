...
A noter qu'il existe des modèles de plans de gestion de données dits "de structure" dont la période considérée est au-delà de la durée d'un seul projet. (voir si on a des références à indiquer)
