...
Il convient de prendre en compte les besoins des utilisateurs du projet, quelquefois appelés "use case", et les besoins entre les différents sytèmes qui seront sollicités, qu'ils existent déjà ou qu'ils soient élaborés pour le projet. [MCQ - début : j'ai du mal avec cette phrase : je ne la trouve pas très clair : MCQ - FIN]
