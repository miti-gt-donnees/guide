...
A cette étape, on aura déjà identifié les grands objectifs du projets et on se sera éventuellement appuyé sur la partie "Imaginer" de ce document.[ML utilité? ]
...
Une fois que les données [CH-*Je trouve le terme données ici confus - Ne peut-on pas dire plutôt une fois les éléments nécessaires à la gestion du projet ? on pourrait croire qu'il s'agit des données collectées or nous n'en sommes pas là ?*] sont acquises et stockées sur un environnement de travail, à ce stade il est important de prévoir une **sauvegarde** pour les données qui seront collectées, 
...
** ATTENTION la description des infrastructures est maintenant à la page Infrastructures !!! Ne pas mettre à jour ici 

*****Début de la partie transférée*****
...
*****FIN de la partie transférée*****


**Prévoir les modes de collecte et de stockage** 


**Prévoir d'utiliser un cahier de laboratoire** [CH- *Attention on le dit déjà dans collecter*]
...
******* transféré aussi dans Infrastructures : ne pas modifier ici *******
...
*****FIN de la 2em partie transférée*****
