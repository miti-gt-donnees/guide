...
### Anticiper les interfaçages nécessaires (avec les utilisateurs ou entre bases de données),
   ...
   Dans cette présentation réalisée dans le cadre de l'ANF "Système d’information embarqué, cahier/carnet de terrain et de laboratoire électronique : quelles interactions avec les bases de données ?" du réseau Bases de Donnes en mai 2016, Nadine Mandran, LIG, explique comme intégrer l'utilisateur au sein d'un projet. Elle présente en parallèle, méthode Agile et Démarche centrée utilisateur. Le contenu de cette présentation est très concret et illustré par des exemples. 
  * [MANDRAN, Nadine, 2016. Méthodes pour intégrer l’utilisateur dans la construction des applications](http://rbdd.cnrs.fr/IMG/pdf/utilisateurs\_anfrbdd.pdf?171/5b534aea6e9bfe597fcf71ff840c5cf48c67033c)
