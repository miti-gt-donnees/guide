...
* [Action nationale de Formation « Interfacer les outils mobiles avec son système d’information »](http://rbdd.cnrs.fr/spip.php?article317)
Réseau rBDD   
Sète, 2019

Deux solutions ont été particulièrement étudiées au CEFE : 
* [Développer une application nomade basée sur QGIS : Carnet de terrain électronique](http://rbdd.cnrs.fr/spip.php?article317)
M.C. Quidoz   
RMLL, Montpellier, 2014
* [Développer une applicatin nomade en utilisant ODK : Carnet de terrain électronique](http://rbdd.cnrs.fr/IMG/pdf/deployer_avec_odk.pdf?569/9c7a0e508a744bc2ddd757184ad6427b9505b214)
M.C. Quidoz   
ANF « Interfacer les outils mobiles avec son système d’information, Sète, 2019


C'est d'ailleurs la solution basée sur ODK qui a été utilisé lors de l'ANF « Interfacer les outils mobiles avec son système d’information » cité précédemment car la solution ODK permet de couvrir les étapes allant de la création du formulaire à la sécurisation en bases de données. Deux interventions concernent plus particulièrement la collecte de données : 
