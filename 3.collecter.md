...
Lors de cette ANF, deux interventions concernent plus particulièrement la collecte de données : 
...
C'est cette solution qui est utilisée dans KoboToolbox, qui est en quelque sorte un ODK "packagé".
