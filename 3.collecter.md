...
Deux solutions ont été étudiées au [CEFE](https://www.cefe.cnrs.fr/fr/) : le développement d'une application nomade basée sur le système d'information géographique, libre, multiplate-forme, publié sous licence GPL [QGIS](https://www.qgis.org/fr/site/) ainsi qu'une application nomade utilisant une boite à outils de génération de carnets de terrain électronique [Open Data Kit](https://opendatakit.org/). 

Ce premier retour d'expérience basé sur QGIS détaille l'étude et le développement d'un ensemble d'outils interopérables avec le système d'information du laboratoire CEFE et qui permet aux intervenants sur le terrain de collecter les données : 
:::{admonition}Réference
...
Le deuxième retour d'expérience basé sur ODK a été faite dans le cadre d'une ANF que le réseau rBDD a consacré sur ce thème. En effet, c'est la solution basée sur Open Data Kit (ODK) qui a été utilisé lors de l'ANF « Interfacer les outils mobiles avec son système d’information » , car cette solution permet de couvrir les étapes allant de la création du formulaire à la sécurisation en bases de données. Deux interventions concernent plus particulièrement la collecte de données telles que « la définition de ses besoins pour les outils nomades » par Christine Plumejeaud et Sylvie Ladet ou une présentation de Pierre-Yves Arnould sur « XLSForm » qui est un standard de formulaire basé Excel. 

:::{admonition}Réference
ANF « [Interfacer les outils mobiles avec son système d’information](http://rbdd.cnrs.fr/spip.php?article317) »
Réseau rBDD, Sète, 2019
:::
...
Réseau Zone Atelier, Montpellier, 2018
...
Il est à noter que la collecte sur le terrain nécessite de s'équiper d'un matériel apte à être utiliser sur des terrains parfois hostiles
:::{admonition}Réference
