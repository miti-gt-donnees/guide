...
Un bon nombre d'Instituts et d'auteurs,  gestionnaires de données suivent d'ailleurs ces principes : 
...
* [De la définition au déploiement de standards d'interopérabilité : retour d'expérience de la Direction des Systèmes d'Information (DSI) du BRGM](https://nuage.osupytheas.fr/index.php/s/ROh4LCpHZCWdlHz#pdfviewer)   
Grellet Sylvain, BRGM - Stéphane Loigerot, BRGM   
[Séminaire SIST15, Marseille](https://sist15.sciencesconf.org/index.html)
