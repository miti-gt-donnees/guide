...
Il est important que le processus de collecte des données soit clairement défini. Ainsi, il conviendra de s'assurer que les sytèmes d'acquisition sont bien étalonnés. Par ailleurs, l'ensemble des données produites doit être parfaitement répertorié et enregistré. Nous disposons pour ce faire d’un certain nombre de supports tels que les cahiers de laboratoires, les carnets de terrain... 
