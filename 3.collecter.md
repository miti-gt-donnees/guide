...
Le Dublin Core <https://fr.wikipedia.org/wiki/Dublin_Core> C'est un vocabulaire du web sémantique utilisé pour exprimer les données dans un modèle RDFa. Issu d'un consensus international et multidisciplinaire
...
La formation et la documentation associée permet de :
