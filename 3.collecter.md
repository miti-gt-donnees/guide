...
Le recueil des métadonnées ainsi que la rédaction et la mise à jour des métadonnées dans des fiches adaptées peut etre ressentie comme contraignante. Il est nécessaire autant que faire se peut de pouvoir automatiser la constitution des catalogues avec des interfaces de programmation (API) disponibles.
