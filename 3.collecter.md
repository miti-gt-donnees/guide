...
### Métadonnées et formats de données
...
Les référentiels de métadonnées peuvent être soit des standards, soit des normes, et sont des documents importants qui se chargent de définir les *informations nécessaires pour décrire les données elles mêmes*. Ils sont de ce fait utilisés pour donner toutes les informations nécessaires à l'utilisation des données, et faciliter leur interopérabilité et réutilisabilité. 
...
#### Les référentiels en information Géographique 
...
Les standards OGC sont importants à connaitre  dans la mesure où ils définissent les protocoles et formats interopérables à suivre pour être interopérables. Ils ont été présentés à plusieurs reprises par François André dans les réseaux DEVLOG, et dans le réseau SIST de l'INSU préoccupés par les besoin d'interopérabilités dans la gestion des données des Observatoires de l'INSU.
