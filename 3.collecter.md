...
Développer l'interopérabilité consiste donc à mettre en place des normes et des standards qui fixent des règles permettant d'assurer le bon fonctionnement de deux systèmes informatiques.
...
- La première partie de sa présentation porte sur les fichiers de données (organisation et nommage, format et critères d’interopérabilité-pérénité) 
...
[MCQ - début : dans la présentation de Marie Puren citée précédemment, il y a des pages sur les standards de métadonnées (page 49 à 55) et page 56 elle explique comment les trouver (les liens n'ont pas l'air de marcher). Pour ma part je fais souvent référence à celui de dcc https://www.dcc.ac.uk/guidance/standards/metadata). Dans ce guide, je ne pense pas que ca soit utile de détailler quelques standarts comme c'était prévu mais peut être plutot d'expliquer comment les retrouver et d'insister sur le fait que même si c'est un standart,  il n'est à utiliser que si il est reconnu dans sa discipline. De plus il faut peut être indiquer que le choix d'un standart est certes important mais qu'il existe des "moulinettes" pour passer d'un standart à l'autre. : fin - MCQ]
...
Dans le domaine environnemental, pour des données qui sont souvent *géolocalisées* par des coordonnées latitude/longitude, l'Open Geospatial Consortium (OGC), est un consortium international qui a pour objectif de développer et promouvoir des standards ouverts, les spécifications OpenGIS, afin de garantir l'interopérabilité des contenus, des services et des échanges dans les domaines de la géomatique et de l'information géographique. 
...
François André   
[Séminaire SIST15 à Marseille OSU Pytheas](http://sist15.sciencesconf.org)  
...
-    **[CS-W](https://www.ogc.org/standards/cat)** - _Catalog Service for the Web_ : Le protocole est destiné à diffuser et explorer des fiches de métadonnées présentes dans un catalogue, et permettre l'interrogation de catalogues de métadonnées. Une très bonne implémentation de ce protocole est réalisée dans le logiciel "Geonetwork" <https://geonetwork-opensource.org/> utilisé pour constituer des catalogues et des inventaires de jeux de données et les présenter sur le Web de manière interopérable. 
...
Ce protocole est notamment utilisé dans les logiciels "GeoNetWork" et des serveurs cartographiques comme "GeoServer" pour positionner des données sur une carte et fournir les données relatives aux points de mesure.

Le réseau SIST a organisé des formations spécifiques sur les logiciels "GeoServer", "GeoCMS" mettant en oeuvre le standard WMS : https://sist.cnrs.fr/les-formations/anf-2017-1, https://sist.cnrs.fr/les-formations/anf-2018 pour lesquelles, les supports de formation sont disponibles en ligne
...
François André a présenté ces protocoles standards de l'OGC lors du Séminaire du réseau SIST2015 à l'OSU Pytheas de Marseille <https://sist15.sciencesconf.org/program>

* [Normes OGC](https://sist15.sciencesconf.org/data/program/ogc.pdf)
François André OMP Toulouse   
Séminaire du réseau SIST2015 à l'OSU Pytheas de Marseille   
...
[ok ML et AR] - [Relu et modifié en conséquences]
[MCQ - début : il faudrait trouver une présentation à mettre pour faire référence sinon on se demande pourquoi on parle de cela dans le guide ..... : fin - MCQ]
...
Chaque utilisateur en fonction de son profil et de ces compétences peut choisir une technologie partant de simples outils clic-bouton comme les aspirateurs de site qui permettent de réaliser des opérations basiques de scraping jusqu’à l’utilisation de langages plus performants comme R ou Python pour des utilisateurs plus avancés vers l’analyse des données.
...
[MCQ - début : on ne parle pas de https://www.elabftw.net/ ? on devrait bien trouver une petite présentation faite dans le cadre d'un réseau : fin - MCQ]
...
### Tablettes et carnets de terrain
 ...
 Certains sites peuvent aujourd’hui être des terrains de guerre et seuls les documents produits lors d’une mission restent utilisables pour la recherche actuelle et future. Il est de ce fait essentiel que ces données soient répertoriées et archivées. [MCQ - début : je ne comprend pas cette référence à la guerre - fin - MCQ]
...
[MCQ - début : pour ma part je construirai le paragraphe de la façon suivante en s'inspirant de ce qui est mis sur cette page https://www.pi4x4.cnrs.fr/carnets-de-terrain-electroniques/ (c'est un groupe de travail resinfo - rbdd). je te fais des copier coller que je te laisse rerédiger
...
- Atelier « Carnets de terrain électroniques », Mars 2018, Montpellier http://rbdd.cnrs.fr/spip.php?article270
- Séminaire « Système d’information embarqué, cahier/carnet de terrain et de laboratoire électronique : quelles interactions avec les bases de données ? », Octobre 2016, http://rbdd.cnrs.fr/spip.php?article206
- Séminaire « les technologies mobiles : retours d'expériences et prospectives », Octobre 2016, https://indico.mathrice.fr/event/27/other-view?view=standard
- Action nationale de Formation « Interfacer les outils mobiles avec son système d’information », 03-05 juin 2019, Sète, http://rbdd.cnrs.fr/spip.php?article317

Deux solutions ont été particulièrement étudiées au CEFE : 
- Développer une application nomade basé sur QGIS
   Carnet de terrain électronique, Juillet 2014, Montpellier, https://rmll.ubicast.tv/videos/carnet-de-terrain-electronique/
- Développer une application nomade en utilisant ODK
...
C'est d'ailleurs la solution basée sur ODK qui a été utilisé lors de l'ANF « Interfacer les outils mobiles avec son système d’information » cité précédemment car la solution ODK permet de couvrir les étapes allant de la création du formulaire à la sécurisation en bases de données. Deux interventions concerne plus particulièrement la collecte de donnée : 
...
Pierre Yves Arnould (CNRS / )
ANF « Interfacer les outils mobiles avec son système d’information », 03-05 juin 2019, Sète

C'est cette solution qui est utilisé dans KoboToolbox, qui est en quelque sorte un ODK "packagé"

--- j'enleverai d'ici
Certains outils comme KoboToolbox permettent également de faciliter l'acquisition des données de terrain en utilisant des appareils mobiles, comme smartphone ou tablettes.Il est bien adapté au recueil de données en envvironnement difficile. On en trouvera une bonne description dans le document de F. Akouette ci dessous :
--- a ici
...
-- début : Après je ne sais pas si c'est l'endroit de parler de cela car c'est du materiel
* [Pi 4X4 Conception d'une tablette de terrain pour la recherche](http://rbdd.cnrs.fr/IMG/pdf/borderes_atelier2018.pdf?441/72f4dc952e0ac74b725a41d43bc28bb07ecdef38). 
Serge Bordères, Centre d’études Nucléaires de Bordeaux-Gradignan
Atelier "carnets de terrain ", Montpellier. 2018.
...
Mathias Rouan
-- fin : Après je ne sais pas si c'est l'endroit de parler de cela car c'est du materiel


--------debut : mis plus haut -------------- sans le commentaire
...
--------fin : mis plus haut -------------- sans le commentaire--------
fin - MCQ]
