...
Dans le domaine environnemental et des données géolocaliées, l'OGC "Open Geospatial consortium" est l'organisme internatinoal qui à l'instar du WWC pour le Web,  edicte et propose des
standards dans le domaine des formats de fichiers et des protocoles d'échanges, pour les données géospatialisées
...
Parmi les standards les plus connus édictés par l'OGC, on peut citer :
