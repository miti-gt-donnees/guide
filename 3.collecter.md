...
Parmi les standards les plus connus édictés par l'OGC et assez utilisés dans nos réseaux métiers parmi les gestionnaires de données environnementales, on peut citer :
...
Le réseau SIST organise 2 actions de formation sur ces logiciels : <https://sist.cnrs.fr/les-formations>
...
dans les données des Observatoires de l'INSU.
  ...
  *  Présentations des Normes OGC (Open Geospatial Consortium)
      * François André
...
### La gestion des collections ...et des jeux de données [?]
[est ce qu'on met sur le meme chapitre la gestion des collections et les catalogues de jux de données?? ML]
...
**Pourquoi un catalogue de métadonnées ?**
 ...
 <https://geonetwork-opensource.org/> qui utilise
 le standard CSW de l'OGC (cf plus haut) et permet de décrire des jeux de données avec des fiches utilisants des metadonnées issues de la norme ISO 19115, ISO 19139
 et du Dublin Core.
...
#### Utiliser des protocoles interopérables
