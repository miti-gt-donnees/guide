...
Les normes de métadonnées sont des normes qui se chargent de définit les informations nécessaires pour décrire les données elles mêmes. Elles sont employées pour la structuration des ressources informatiques en général et l'interopérabilité informatique.  [*CH - Ajouter la source :  wikipédia ?*]
