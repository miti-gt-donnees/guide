...
Le standards OGC sont développés par les membres du consortiul et destinés aà rendre les informations géospatialisées AIR Findable, Accessible, Interoperable and Reusable". 

Ces standards répondent à un certains nombres
...
- 52North : <https://52north.org/software/software-projects/sos/> une application qui fournit une interface web interopérable pour l'insertion et l'interrogation des données et
...
Ces 2 logiciels ont été présentés par leurs auteurs lors du séminaire SIST en 2015 à Marseille. Le réseau SIST organise 2 actions de formation sur ces logiciels : <https://sist.cnrs.fr/les-formations>
