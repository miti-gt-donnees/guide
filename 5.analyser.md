...
Derrière le terme "analyser" s'entend l'utilisation de puissance de calcul afin d'extraire de l'information des données.
...
Plusieurs évènements récurrents, annuels ou bisannuels, comme les JCAD (Journées Calcul et Données), les JDev (Journées du DEVeloppement logiciel) par exemple, intègrent de nombreuses interventions sur ces différentes thématiques, allant de la description des plateformes aux outils disponibles, en passant par l'organisation des développements et la reproductibilité. Ils incluent aussi très souvent des retours d'expérience particulièrement riches.

## Plateformes de traitement de données

GR : voir concevoir planifier 
...
Ces infrastructures font régulièrement l'objet de présentation qui permettent de comprendre leur organisation et mode de fonctionnement, et de suivre leurs évolutions.
Parmi celles-ci, on peut citer :

- le cloud européen EOSC (European Open Science Cloud) qui a été abordé par Volker Beckmann, chargé de mission CNRS-EOSC, lors des [JCAD 2019](https://jcad2019.sciencesconf.org/data/EOSC_FranceGrilles_Beckmann_20191011.pdf), et a fait l'objet d'une [ journée spéciale au CNRS en janvier 2020](https://indico.in2p3.fr/event/20051/). Cette journée a en particulier permis de faire le point sur l'implication française dans le projet à travers plusieurs exemples.

- La grille européenne EGI, qui a été présentée aux JCAD 2018 sous deux angles :
	- une présentation générale, et son interaction avec EOSC[une présentation générale, et son interaction avec EOSC](https://jcad2018.sciencesconf.org/data/20181024_JCAD_EGI_v1.1.pdf) ,
	...
	- puis une [intervention aux JCAD 2019 par Baptiste Grenier d'EGI Foundation](https://jcad2019.sciencesconf.org/data/EGI_update_about_services_2019_10_10_JCAD_v3_vf.pdf)  permettant de voir l'évolution des services d'EGI.

### Plateformes nationales

Les plateformes de calcul intensif nationales, ainsi que leurs évolutions, sont régulièrement présentées par l'opérateur GENCI (Grand Equipement National pour le Calcul Intensif) :
...
Des aspects techniques plus spécifiques font aussi l'objet de présentations : 

- le projet DOMA de stockage de données scientifiques, lié au Centre de Calcul de l'IN2P3 :
	- une [première vue du projet au JCAD 2018](https://jcad2018.sciencesconf.org/data/DOMA_JCAD_v2.pdf),
	- [son évolution un an après lors des JCAD 2019](https://jcad2019.sciencesconf.org/data/DOMA_JCAD_2019_v2.pdf).
- de nombreuses présentations très techniques peuvent également être trouvées dans une [action de formation de 2018 (User Tools For HPC)](https://ust4hpc.sciencesconf.org/resource/page/id/2)  à destination des administrateurs système des machines de calcul et aborde différents sujets : déploiement HPC dans le cloud, système de conteneurs Singularity, orchestrateur Slurm et Kubernetes, packaging HP via nix, Easypack et systèmes de stockage parallèle et distribué.
...
- Python devient de plus en plus utilisé en science des données. 
...
- Méthodes variationnelles pour l’imagerie
 ...
 Cette approche a été abordé lors d'une [école thématique qui a eu lieu en 2017](https://calcul.math.cnrs.fr/2017-09-anf-reduction-dimension.html).
...
https://sari.grenoble-inp.fr/doku.php?id=theme:ia_deep_learning:ia_deep_learning:ia

 IA
  http://devlog.cnrs.fr/jdev2020/t8
  
  jdev2017
  http://devlog.cnrs.fr/jdev2017/t7
  
  IA
 https://indico.mathrice.fr/event/130/contributions 
...
Un des outils d'analyse les plus fréquents correspond à la visualisation des données. Cette visualisation peut s'avérer particulièrement délicate dans le cadre de très gros volumes de données, et nécessite de s'appuyer sur des solutions techniques spécifiques.
 ...
 Dans le domaine des données numériques, plusieurs bibliothèques sont particulièrement adaptées aux données de grande taille, ainsi qu'à la visualisation in-situ, c'est-à-dire en cours de calcul en ce qui concerne les données de simulation : VisIt et ParaView. Plusieurs interventions sur ce sujet ont été réalisés dans le cadre d'une [journée dédiée organisée en 2017 par le réseau Calcul](https://calcul.math.cnrs.fr/2017-12-atelier-visualisation.html) .
  ...
  Visualisation
  https://calcul.math.cnrs.fr/2016-11-anf-visu-data.html
  
## Optimiser l'utilisation des ressources

https://calcul.math.cnrs.fr/2019-09-anf-perf-eval-hpc.html

https://calcul.math.cnrs.fr/2019-05-atelier-optimisation.html

## Retour d'expérience

 https://jcad2019.sciencesconf.org/data/JACD_2019_datalake_CNES.pdf
   Infras de traitement de données

https://jcad2019.sciencesconf.org/data/4P.pdf
   plateforme de traitement des données phénotypage haut débit 

  https://jcad2018.sciencesconf.org/data/25octobre_pres11strategies_replication_Chai.pdf
   Réplication de fichiers pour systèmes distribués

https://jcad2019.sciencesconf.org/data/20191009_JCAD2019TutoDaskJobArray.pdf
   Job array à dask

   https://jcad2019.sciencesconf.org/data/Briol_pangeo_swot_jcad2019_2019_10_10.pdf
   PANGEO

https://jcad2018.sciencesconf.org/data/9_OpenDose_JCAD.pdf
   https://jcad2019.sciencesconf.org/data/OpenDose_JCAD2019_v2.pdf
   OpenDose

  https://jcad2019.sciencesconf.org/data/20191002_JCAD_CEBA.pdf
   Datalake pour écosystèmes environnementaux

  https://jcad2018.sciencesconf.org/data/afranc_jcad_2018_vendredi.pdf
   Traitement de données metabarcoding
