...
*Contexte: Les réseaux participent à cette étape du cycle de vie en* identifiant les p*roblématiques techniques, en proposant des outils technologiques les plus pertinents* pour accompagner la construction, la mise en œuvre du projet et la valorisation des résultats. Pour réaliser cet accompagnement, les réseaux organisent une* veille  sur  les  nouvelles  technologies  en  émergence * permettant  le  traitement  et  l’analyse  des  données,  sur  les  nouveaux  supports de valorisation de la recherche,  les  *contraintes  et  opportunités  qu’elles  soient  réglementaires,  juridiques*  (politiques d’Open Data,  H2020  par  exemple)  ou  bien  techniques, technologiques (TDM, ...) ou encore organisationnelles (plans de gestion de données). L’apport des réseaux dans cette étape est également important en termes de croisement des disciplines et des métiers permettant un accompagnement de haute valeur*
