...
Certains Instituts du CNRS supportent également des réseaux technologiques qui viennent en support à leurs axes stratégiques scientifiques. [L’INSU par exemple labellise des réseaux](https://www.insu.cnrs.fr/fr/structures) en support aux moyens d'observation et à la gestion des données environnementales comme le réseau [SIST](http://sist.cnrs.fr), [au développement instrumental](https://www.insu.cnrs.fr/institut_insu/fr/cnrsinfo/le-reseau-ingenierie-systeme-ris-ouvre-ses-portes) , [au Management de Projets](http://mapi.cnrs.fr/) , etc.
