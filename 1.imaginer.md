...
- [L’INSU par exemple labellise certains réseaux](https://www.insu.cnrs.fr/fr/structures) en support à sa ligne scientifique. D'autres comme 
...
- [MATE-SHS](https://mate-shs.cnrs.fr/) pour la production, le traitement, l’analyse et la représentation des données dans la recherche en Sciences Humaines et Sociales (SHS) ou le 
- réseau QUETELET (Réseau français des centres de données pour les sciences sociales ) qui à travers [Quetelet PROGEDO Diffusion](http://quetelet.progedo.fr/)  permet de rechercher et d’accéder à des données issues de la statistique publique nationale (grandes enquêtes recensements, bases de données) et de grandes enquêtes provenant de la recherche française.
Il est possible également de s’appuyer sur l’expertise de réseaux thématiques comme par exemple, 
- [CAI-RN](https://archeometrie.cnrs.fr/) pour l'archéométrie 
